...
<!--INICIO-->
    <div class="fondo">
        <figure>
            <img class="fon"
            src="../img/ceviche.jpg" alt="">
            <div class="Capaf">
                <div class="Prueba">
                <img class="portada"  src="../img/portada.jpeg" alt=""></div>
...
<!--FIN DE INICIO-->
 ...
 <div class="menuPrincipal">            
    ...
    <div class="Comida">
        <a href="./reserva.php"><img src="../img/arrozchaufa.jpg"></a>
        <div class="detalles123">
            <div class="detalles123-sub">
                <h5>Arroz Chaufa</h5>
                <h5 class="price"> S/30 </h5>
            </div>
            <p>DISPONIBLE</p>
        </div>
    </div>
    ...
    <div class="Comida">
    <a href="./reserva.php"><img src="../img/causa.jpg"></a>
        <div class="detalles123">
            <div class="detalles123-sub">
                <h5>Causa Rellena</h5>
                <h5 class="price"> S/20 </h5>
            </div>
            <p>DISPONIBLE</p>
        </div>
    </div>
    ...
    <div class="Comida">
    <a href="./reserva.php"><img src="../img/ceviche12.jpg"></a>
        <div class="detalles123">
            <div class="detalles123-sub">
                <h5>Ceviche</h5>
                <h5 class="price"> S/40 </h5>
            </div>
            <p>DISPONIBLE</p>
        </div>
    </div>
    ...
    <div class="Comida">
    <a href="./reserva.php"><img src="../img/ArrozMariscos.jpg"></a>
        <div class="detalles123">
            <div class="detalles123-sub">
                <h5>Arroz con Mariscos</h5>
                <h5 class="price"> S/35 </h5>
            </div>
            <p>DISPONIBLE</p>
        </div>
    </div>
    ...
    <div class="Comida">
    <a href="./reserva.php"><img src="../img/carapulcra.png"></a>
        <div class="detalles123">
            <div class="detalles123-sub">
                <h5>Carapulcra con Sopa Seca</h5>
                <h5 class="price"> S/32 </h5>
            </div>
            <p>DISPONIBLE</p>
        </div>
    </div>
    ...
    <div class="Comida">
    <a href="./reserva.php"><img src="../img/lomosaltado.jpg"></a>
        <div class="detalles123">
            <div class="detalles123-sub">
                <h5>Lomo Saltado</h5>
                <h5 class="price"> S/23 </h5>
            </div>
            <p>DISPONIBLE</p>
        </div>
    </div>
...
<div class="contenidoPaginaNosotros">
    ...
    <div class="nosotrosdiv1">
        <div class="nosotrosImagen"> 
            <img src="../img/img_acercaNosotros.jpeg">
        </div>

        <div class="nosotrosInfo">
            <h2 class="h2Acerca_Nosotros">Acerca de Nosotros - -</h2>
                    <p class="descripcion">Somos unos de los restaurantes mas vistados ya sea de forma 
                        nacional como internacional. Además, nuestro historial respecto
                        a las criticas es pulcro y sobrsaliente. Como nuestro mismo
                        nombre indica, nos dedicamos a reproducir las delicias
                        peruanas para el placer del comensal. <br><br>
    
                        Nuestra dedicación no es medible pues nos enfocamos a ser
                        mejores que ayer. <br><br>
                    
                        DIRECCIÓN: Calle Bolívar 164, Miraflores 15074 <br><br> RUC: 10649364722</p>

                        <div class="datosEmpresa">
                            <div class="dato1">
                                <h2 class="numero1">15</h2>
                                <p class="datosAdicionales">Años de experiencia</p>
                            </div>
                            <div class="dato2">
                                <h2 class="numero2">+10</h2>
                                <p class="datosAdicionales" >Locales por región</p>
                            </div>
                        </div>
        </div>
    </div>
    ...
    <div class="misionVisionValores">
        <div class="valores">
            <div class="section-title ff-secondary text-start letracompañia">
                <h4>Valores</h4>
            </div>
            <p> <b>- Confianza</b></p>
            <p> <b>- Responsabilidad</b></p>
            <p> <b>- Integración</b></p>
            <p> <b>- Disponibilidad <br>&nbsp de cambio</b></p>
            <p> <b>- Pasión</b></p>
        </div>
        <div class="vision">
            <div class="section-title ff-secondary text-start letracompañia">
            ...
            <p> <b>Buscamos en el 2022 ser uno de los restaurantes<br> más destacados</b></p>
            <p> <b>Ofrecer los mejores platos y un servicio de calidad</b></p>
            <p> <b>Con nuestro sabor, creatividad, nuestras comidas<br> y bebidas; pretendemos llegar a tener 5 estrellas</b></p>
        </div>
        <div class="mision">
            <div class="section-title ff-secondary text-start letracompañia">
                <h4>Misión</h4>
            </div>
            <p> <b>Satisfacer las necesidades gastronómicas <br> de nuestros clientes</b></p>
            <p> <b>Ofrecer alimentos y servicios con la más<br> 
            alta calidad</p>
            <p>Superar las expectativas y además ser un<br>
            espacio de trabajo que permita el desarrollo<br>
            de sus colaboradoresy su constante aprendizaje</b></p>
...
<div class="contenido" >
    <div class="titulopag">
    <p><h5 class="section-title ff-secondary letranom">Nuestros desarrolladores web</h5> </p> 
