...
<body id="principio">
    ...
    <header>
            <a href="/RESTAURANTE/views/inicio_sesion/dashboard/visualizar/inicio.php" class="logo">
                <img src="/RESTAURANTE/views/img/utencilios.png" alt="logo de la compañia" class="logo-img">   
                <h2 class="logo-nombre">SABOR 
                    PERUANO</h2>
            </a>
         <nav class="opciones">   
                <a href="/RESTAURANTE/views/inicio_sesion/dashboard/visualizar/inicio.php" class="nav-link">INICIO</a>
                <a href="/RESTAURANTE/views/inicio_sesion/dashboard/visualizar/nosotros.php" class="nav-link">NOSOTROS</a>
                <a href="/RESTAURANTE/views/inicio_sesion/dashboard/visualizar/servicio.php" class="nav-link">SERVICIO</a>
                <a href="/RESTAURANTE/views/inicio_sesion/dashboard/visualizar/equipo.php" class="nav-link">EQUIPO</a>
                <a href="/RESTAURANTE/views/inicio_sesion/dashboard/visualizar/chef.php">CHEFS</a>
                <a href="/RESTAURANTE/views/inicio_sesion/dashboard/visualizar/contacto.php"class="nav-link">CONTACTOS</a>
                <a href="/RESTAURANTE/views/index.php" > 
               <?php echo $_SESSION["s_usuario"];?>
               <i class="fas fa-fw fa-eye-slash"></i>
               </a>  
               <a href="/RESTAURANTE/views/inicio_sesion/dashboard/visualizar/reserva.php" class="reservar">RESERVAR UNA MESA</a> 
         </nav>
    </header>
    ...
    <div class="contenedor">
        <figure>
            ...
            <div class="Capa">
                ...
                <nav>
                    <p>
                    <a href="/RESTAURANTE/views/inicio_sesion/dashboard/visualizar/inicio.php" class="iniciopag">INICIO </a>
...
<form action="/RESTAURANTE/controllers/controlador_admin_reservar.php" method="post">
         <div class="contenido_reserva"> 
          <br> <br>
          <div >
              <a href="./reserva.php" class="cerrar">NUEVO</a>
            </div>
...
<!--FOOTER-->
    ...
    <section class="casillas"> 
        ...
        <div class="orden pp"> 
            ...
            <a class="btn btn-link" href="/RESTAURANTE/views/inicio_sesion/dashboard/visualizar/nosotros.php">Sobre nosotros</a>
            <a class="btn btn-link" href="/RESTAURANTE/views/inicio_sesion/dashboard/visualizar/contacto.php">Contactenos</a>
            <a class="btn btn-link" href="/RESTAURANTE/views/inicio_sesion/dashboard/visualizar/reserva.php">Reserva</a>
    ...
    <div class="espacioA">
        <section class="grupo">
       &copy; <a class="letrasb" href="/RESTAURANTE/views/inicio_sesion/dashboard/visualizar/inicio.php">SABOR PERUANO</a>, todos los derechos reservados.
        </section>
      
        <section class="grupo">
        Página desarrallado por<b class="espacio"> </b><a class="letrasb" href="/RESTAURANTE/views/inicio_sesion/dashboard/visualizar/equipo.php">El grupo 1</a>
    </section>
    </div>
    <!--FIN FOOTER-->
    <!-- chatbot -->
