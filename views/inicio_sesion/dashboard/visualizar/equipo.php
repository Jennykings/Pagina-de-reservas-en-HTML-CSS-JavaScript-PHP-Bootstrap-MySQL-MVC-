...
<body id="principio">
    ...
    <header>
         ...
         <nav class="opciones">   
                ...
                <a href="./equipo.php" class="nav-link servicio">EQUIPO</a>
...
<div class="contenido" >
    ...
    <b><h1 class="mb-5 letranomPrincipal">Integrantes del grupo 1</h1></b>
    </div>
...
<div class="ordencuadros">
    <div class="integrantes">
        <center><img src="/RESTAURANTE/views/img/Lume.png" alt="" height="200" width="200"></center>
        <h5>Lume Camargo, Nayely Erika</h5>
        <p>U20210477</p>
        <p>Se encargo de la creación de redes sociales, diseño de las paginas INICIO , CONTACTO y CHEFS.</p>
    </div>
</div>
<div class="ordencuadros">
    <div class="integrantes">
        <center><img src="/RESTAURANTE/views/img/Reyes.jpeg" alt="" height="200" width="200"></center>
        <h5>Reyes Aguilar, Shirley Jennifer</h5>
        <p>U20207461</p>
        <p>Se encargo del diseño de los encabezados, pie de pagina, EQUIPO, RESERVA, NOSOTROS y de SERVICIOS.</p>
    </div>
</div>
 </div> 
  <div class="cap2"> 
<div class="ordencuadros">
    <div class="integrantes">
        <center><img src="/RESTAURANTE/views/img/Gaspar.jpeg" alt="" height="200" width="200"></center>
        <h5>Gaspar Veliz, Pedro Enrique</h5>
        <p>U20215325</p>
        <p>Se encargo del contenido de las redes sociales y del diseño de la pagina de MENÚ.</p>
    </div>
</div>
 </div> 
</section>
        ...
        <div>
            <h4 class="section-title ff-secondary text-start letracompañia">Boletin informativo</h4>
                        ...
                        <div class="position-relative mx-auto bt"> 
                            <input class="correo" type="email" placeholder="Tu correo" id="inscribirse" required>
